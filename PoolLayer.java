...
public class PoolLayer implements ILayer {
            ...
            for(int fx=0;fx<this.sx;fx++) {
              for(int fy=0;fy<this.sy;fy++) {
                ...
                if(oy>=0 && oy<V.sy && ox>=0 && ox<V.sx) {
                  ...
                  if(v > a) { a = (int)v; winx=ox; winy=oy;}
                }
              }
            }
    ...
    public void load(JSONObject json) throws JSONException {
        this.sx = json.getInt("sx");
        this.sy = json.getInt("sy");
        this.stride = json.getInt("stride");
        this.pad = json.getInt("pad");
